...
def add_teacher():
    ...
    try:
        ...
        # 3. Send Email with Login Credentials (DISABLED TEMPORARILY DUE TO MEMORY ISSUES)
        # try:
        ...
        # Temporarily disabled email due to memory issues
        print(f"[EMAIL DISABLED] Staff {full_name} added. Username: {username}, Password: {password}")
        flash(f'Staff {full_name} added successfully! Username: {username}, Password: {password}', 'success')
